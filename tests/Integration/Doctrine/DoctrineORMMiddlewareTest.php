...
namespace Tests\Paysera\RoadRunnerBundle\Integration\Doctrine;

use Paysera\RoadRunnerBundle\Event\ForceKernelRebootEvent;
...
use Tests\Paysera\RoadRunnerBundle\Utils\CallableHttpKernel;

use function Paysera\RoadRunnerBundle\consumes;
