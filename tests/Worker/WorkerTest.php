...
namespace Tests\Paysera\RoadRunnerBundle\Worker;

use AllowDynamicProperties;
use Paysera\RoadRunnerBundle\Event\WorkerExceptionEvent;
use Paysera\RoadRunnerBundle\Event\WorkerKernelRebootedEvent;
use Paysera\RoadRunnerBundle\Event\WorkerStopEvent;
...
use Paysera\RoadRunnerBundle\Worker\HttpWorker;
...
class WorkerTest extends TestCase
{
    ...
    /**
     * @testWith [ "Paysera\\RoadRunnerBundle\\Event\\WorkerStartEvent" ]
     *           [ "Paysera\\RoadRunnerBundle\\Event\\WorkerStopEvent" ]
     */
